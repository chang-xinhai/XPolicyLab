...
from xpl_idp3.model.common.module_attr_mixin import ModuleAttrMixin
...
class LowdimMaskGenerator(ModuleAttrMixin):
    ...
    def forward(self, shape, seed=None):
        device = self.device
        B, T, D = shape
        assert D == (self.action_dim + self.obs_dim), f"dim mismatch: {D} != {self.action_dim} + {self.obs_dim}"
