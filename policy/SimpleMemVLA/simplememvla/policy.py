...
from .modeling_simplememvla import SimpleMemVLAForActionPrediction
from .normalize import MeanStdNormalizer, load_stats_file
from .subtask_span import answer_span_token_ids, subtask_span_mask
...
class SimpleMemVLAPolicy:
    ...
    def __init__(
        ...
        self.camera_labels = dict(camera_labels)
