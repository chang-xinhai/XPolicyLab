...
**Contributor:** XPolicyLab contributors | **Paper:** ManiFlow: A General Robot Manipulation Policy via Consistency Flow Training | **arXiv:** [2509.01819](https://arxiv.org/abs/2509.01819) | **Original code:** [geyan21/ManiFlow_Policy](https://github.com/geyan21/ManiFlow_Policy)
...
No task-independent pretrained policy weights are required. Train a task checkpoint before evaluation; debug/smoke checkpoints are not task policies. XYZ and XYZRGB are supported. The consistency loss receives an EMA teacher; default inference uses 2 flow steps, not DDIM.
